...
public class FWParser extends Parser {
	...
	public static class CommandContext extends ParserRuleContext {
		public TerminalNode NAME() { return getToken(FWParser.NAME, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FWListener ) ((FWListener)listener).enterCommand(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FWListener ) ((FWListener)listener).exitCommand(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FWVisitor ) return ((FWVisitor<? extends T>)visitor).visitCommand(this);
			else return visitor.visitChildren(this);
		}
	}
